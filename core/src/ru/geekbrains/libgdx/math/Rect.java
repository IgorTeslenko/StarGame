package ru.geekbrains.libgdx.math;
...
public class Rect {
    ...
    public Rect(ru.geekbrains.libgdx.math.Rect from) {
    ...
    public void set(ru.geekbrains.libgdx.math.Rect from) {
        pos.set(from.pos);
    ...
    public boolean isOutside(ru.geekbrains.libgdx.math.Rect other) {
